...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'spost_shortpost', (
        ...
        db.send_create_signal(u'spost', ['ShortPost'])

        # Adding M2M table for field tags on 'ShortPost'
        m2m_table_name = db.shorten_name(u'spost_shortpost_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shortpost', models.ForeignKey(orm[u'spost.shortpost'], null=False)),
            ('tag', models.ForeignKey(orm[u'tag.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['shortpost_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'ShortPost'
        db.delete_table(u'spost_shortpost')

        # Removing M2M table for field tags on 'ShortPost'
        db.delete_table(db.shorten_name(u'spost_shortpost_tags'))
