...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'comment_comment', (
            ...
            ('parent_author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent_author', to=orm['auth.User'])),
        ))
    ...
    models = {
        ...
        u'comment.comment': {
            ...
            'parent_author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parent_author'", 'to': u"orm['auth.User']"}),
